...
```text
results/models/ann_lstm_tuned_assignment_model.pt
results/test_outputs/ann_lstm_tuned_hidden_prediction_submission.npz
results/test_outputs/ann_lstm_tuned_hidden_simulation_submission.npz
```
...
results/plots/lstm_tuning_results.csv
