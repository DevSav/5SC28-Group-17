...
\begin{IEEEkeywords}
unbalanced disk, system identification, artificial neural network, Gaussian process, NARX, DQN, reinforcement learning, swing-up control, reference tracking
\end{IEEEkeywords}
...
\input{Tracking_Reference}

\input{Real_Setup_Test}
...
the same type of hyperparameters.
