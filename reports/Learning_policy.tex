...
\begin{table}[htbp]
    ...
    \begin{tabular}{lcc}
        ...
        \midrule
        Final error [rad] & $0.021$ & $-0.013$ \\
        Min. abs. error [rad] & $0.021$ & $0.011$ \\
        Last-window error [rad] & $0.024$ & $0.014$ \\
        Saturation ratio & $0.173$ & $0.003$ \\
        Upright ratio & $0.803$ & $0.850$ \\
        RBF mode ratio & $0.827$ & $0.870$ \\
        \bottomrule
    \end{tabular}
...
reduced the last-window error from \(0.024\) rad to \(0.014\) rad and decreased
the saturation ratio from \(0.173\) to \(0.003\). Thus, the simulator-based
